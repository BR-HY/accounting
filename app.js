(function () {
  ...
  const CATEGORY_KEYWORDS = [
    ...
    { category: "水果", words: ["苹果", "梨", "桃", "李子", "杏", "樱桃", "枣", "石榴", "柿子", "无花果", "山楂","草莓", "蓝莓", "树莓", "桑葚", "葡萄", "提子", "猕猴桃", "圣女果", "杨梅","橙子", "橘子", "柚子", "柠檬", "沃柑", "耙耙柑", "丑橘", "砂糖橘", "蜜橘", "金桔","西瓜", "甜瓜", "哈密瓜", "香瓜", "白兰瓜", "羊角蜜", "伊丽莎白瓜","香蕉", "芒果", "菠萝", "荔枝", "龙眼", "木瓜", "椰子", "菠萝蜜"] },
    { category: "买菜", words: ["菜花", "猪肉", "火锅丸子", "芹菜", "花生豆", "小米", "绿豆", "枣", "牛肉", "蒜苔", "葱", "姜", "蒜", "油", "鸡精", "手抓饼", "香肠", "方便面", "馒头", "豆沙包", "面条", "抽", "醋"] },
